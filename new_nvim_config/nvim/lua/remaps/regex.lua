...
vim.keymap.set('n', '<leader>s"', function() myRegexReplacements:surround_selection("quotes") end)
vim.keymap.set('n', '<leader>s{', function() myRegexReplacements:surround_selection("braces") end)
vim.keymap.set('n', '<leader>s[', function() myRegexReplacements:surround_selection("brackets") end)
vim.keymap.set('n', '<leader>s(', function() myRegexReplacements:surround_selection("parens") end)
